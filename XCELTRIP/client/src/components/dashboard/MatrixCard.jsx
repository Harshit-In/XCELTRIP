...
export default function MatrixCard(props) {
  return (
      ...
      <div className="plan_box_container pl-0">
        <div className="line d-flex justify-content-center align-items-center p-0">
          ...
          <a href="#">
            ...
            <span className={`c2 ${props?.slot_ids[1] ? " or " : ""}`}>
              {props?.slot_ids[1] ? (
          ...
          <a href="#">
            ...
            <span className={`c3 ${props?.slot_ids[2] ? " or " : ""}`}>
              {props?.slot_ids[2] ? (
                <span className="mytooltip">ID:{props?.slot_ids[2]}</span>
              ) : null}
            </span>
          </a>
          <a href="#">
            <span className="line4"></span>
            <span className={`c4 ${props?.slot_ids[3] ? " or " : ""}`}>
              {props?.slot_ids[3] ? (
                <span className="mytooltip">ID:{props?.slot_ids[3]}</span>
              ) : null}
            </span>
          </a>
          <a href="#">
            <span className="line5"></span>
            <span className={`c5 ${props?.slot_ids[4]  ? " or " : ""}`}>
              {props?.slot_ids[4] ? (
                <span className="mytooltip">ID:{props?.slot_ids[4]}</span>
              ) : null}
            </span>
          </a>
        </div>
